...
- AutoResearch: bounded research loop — falsifiable hypothesis rounds in a single research log, adversarial verification, distil, evidence-gated re-open requiring third-party-checkable artifacts; authorization levels are configurable (default: round-one hypothesis approval); it adds no extra gate.
