...
- `skills/writing-for-agents` core writing reference and skill mechanics adapted from `mattpocock/skills` `writing-for-agents`; the English body in `references/writing-core.md` and `references/skill-mechanics.md` is kept verbatim from upstream.
